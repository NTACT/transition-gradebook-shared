...
const validTrueBooleans = ['true', 'yes'];
const validFalseBooleans = ['false', 'no'];
...
const columns = [
...

    {
        ...
        required: true,
        validValues: enums.genders,
        field: 'gender',
        type: types.enum,
        deserialize: value => value ? value.toLowerCase() : ''
    },
    ...
    {
        headerText: 'Disabilities',
        validAlias: ['disabilities'],
        type: types.array,
        field: 'disabilities',
        deserialize: value => {
            if (value) {
    ...
    {
        headerText: 'Self-determination skills',
        validAlias: ['hasSelfDeterminationSkills', 'Self-determination skills'],
        validValues: validBooleans,
